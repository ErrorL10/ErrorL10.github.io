...
<body>
    ...
    <header>
        ...
        <h2 class="subtext">Staff Login</h2>
    </header>
    ...
    <div id="form">
        <form action="controller.php" method="POST">
            ...
            <div class="button-panel">
                <button type="submit" name="login" class="btn btn-primary form-button" style="--bs-btn-font-weight: 600;--bs-btn-font-size:1.05rem">Login</button>
            </div>
        </form>
        </div>
